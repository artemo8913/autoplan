...
## TODO:
1. Вынести selectedPoleId в отдельный store (или отдельный селектор), чтобы callback функция по перерисовке опор не менялась и не вызывала перерисовку всех компонентов