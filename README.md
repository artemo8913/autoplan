...
8. То, что сейчас в `features` папке скорее должны быть в `widget` слое. 
...
11. Проанализировать код на соблюдение принципов FSD, проанализировать связанность/сцепленность кода
12. Прочитать, проанализировать и адаптировать код, связанный с инструментами редактирования. Очистить compositionRoot от левого кода
13. После обновить `claude.md` файл, актуализировать задача, структура проекта и прочее.
14. Перенастроить конфигурационный файл tsconfig (чтобы работали диаграммы классов)
15. UIStore - разбить этот монолит на различные сервисы по назначению. В хранилище храним только данные, функционал будет в связанных сервисах
16. ToolTypes - вынести BatchCommand в сервис
