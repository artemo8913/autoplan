...
import type { WireType } from "../types/catenaryTypes";
// =============================================================
// ТИПЫ
// =============================================================
...
interface PoleBaseProps extends SymbolProps {
    ...
    size?: number;
    /** Если задано — форма залита цветом */
    fill?: string;
}
 ...
 */
export const PoleBase: FC<PoleBaseProps> = ({ material, size = 8, s = 2, color = "black", fill = "transparent" }) => {
    const sw = s / 2;
